...
class ScientificManagerUserDirectoryView(LoginRequiredMixin, TemplateView):
    """دایرکتوری کاربران برای مدیر علمی"""

    template_name = "dashboard/scientific_manager/user_directory.html"
    ...
    def get_context_data(self, **kwargs):
        ...
        if RoleService.is_scientific_manager(user):
            exclude_roles.append("scientific_managers")
